...
valid=true   #flag που θα χρησιμοποιηθεί για τον έλεγχο ορθής καταγραφής.

while [[ epilogi -ne 5 || "$valid" == true ]];      #Επανάληψη ώστε να εμφανίζεται το μενού επιλογών μετά την ολοκλήρωαση μι ενέργειας από το μενού.
do
